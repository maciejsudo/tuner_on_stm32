...
KEEP extern const touchgfx::GlyphNode glyphs_NotoSans_Regular_12_4bpp[] FONT_TABLE_LOCATION_FLASH_ATTRIBUTE =
{
    ...
    {   383, 0x0048,   7,   9,   9,   1,   9,   0,   0, 0x00 },
    {   419, 0x007A,   6,   7,   7,   0,   6,   0,   0, 0x00 }
};
...
touchgfx::GeneratedFont& getFont_NotoSans_Regular_12_4bpp()
{
    static touchgfx::GeneratedFont NotoSans_Regular_12_4bpp(glyphs_NotoSans_Regular_12_4bpp, 17, 12, 2, 4, 1, 0, 0, unicodes_NotoSans_Regular_12_4bpp, kerning_NotoSans_Regular_12_4bpp, 63, 0, 0);
